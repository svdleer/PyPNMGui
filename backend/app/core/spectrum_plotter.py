...
def generate_spectrum_plot(
    ...
    # PyPNM standardized light theme (white background) with blue color scheme
    bg_color = '#ffffff'
    plot_bg = '#ffffff'
    grid_color = '#d0d0d0'
    text_color = '#000000'
    line_color = '#1e90ff'  # Blue color scheme
    fill_color = 'rgba(30, 144, 255, 0.15)'
    
    # Set up matplotlib style
    plt.style.use('default')
    
    # Create figure matching PyPNM plot dimensions (14×6 at 150 DPI)
...
def generate_waterfall_plot(
    ...
    # Light theme (matching other plots)
    bg_color = '#ffffff'
    plot_bg = '#ffffff'
    text_color = '#000000'
    grid_color = '#d0d0d0'
    ...
    ax2.plot(freqs/1e6, mags, color='#1e90ff', linewidth=0.5)
    ax2.fill_between(freqs/1e6, mags, mags.min(), color='#1e90ff', alpha=0.15)
