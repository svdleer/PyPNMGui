...
class PyPNMClient:
    ...
    def __init__(self, config: Optional[PyPNMConfig] = None):
        ...
        # Internal PyPNM API calls should not inherit host/container proxy env.
    ...
    def get_channel_estimation_agent(
        self,
        mac_address: str,
        ip_address: str,
        tftp_ipv4: str,
        ...
        """
        Get DS OFDM channel estimation via the PyPNM Agent (no direct SNMP).

        Endpoint: POST /pnm/ds/channel-estimation

        Returns ChannelEstimationResponse:
            success, mac_address, modem_ip, timestamp, filename, error,
            channels: [{channel_id, coefficients:[float...], frequency_mhz}]
        """
        payload: Dict[str, Any] = {
            "modem_ip":   ip_address,
            "mac_address": mac_address,
        ...
        return self._post("/pnm/ds/channel-estimation", payload)
