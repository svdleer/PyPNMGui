...
def pnm_measurement(measurement_type, mac_address):
    ...
    if measurement_type == 'spectrum':
        return _handle_spectrum_measurement(mac_address, modem_ip, community)
...
def _handle_spectrum_measurement(mac_address: str, modem_ip: str, community: str):
    ...
    try:
        ...
        # Step 2: Wait for modem to upload file to TFTP (15s buffer for slow modems)
        # Agent polls for 30s, but file can take up to 60s total to appear on disk
        time.sleep(15)
