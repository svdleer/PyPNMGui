...
# ============== REMOVED ENDPOINTS ==============
# The following endpoints have been REMOVED as part of Phase 3 migration.
# They previously used the old agent manager (simple_ws) which has been deprecated.
#
# Use the /api/pypnm/* endpoints instead, which route through PyPNM API:
#
# - /modem/<mac>/uptime         → Use /api/pypnm/modem/<mac>/channel-stats
# - /modem/<mac>/ds-channels    → Use /api/pypnm/modem/<mac>/channel-stats  
# - /modem/<mac>/us-channels    → Use /api/pypnm/modem/<mac>/channel-stats
# - /modem/<mac>/interface-stats → Use PyPNM API directly
# - /modem/<mac>/rxmer          → Use /api/pypnm/measurements/rxmer/<mac>
# - /modem/<mac>/spectrum       → Use /api/pypnm/measurements/spectrum/<mac>
# - /modem/<mac>/fec-summary    → Use /api/pypnm/measurements/fec_summary/<mac>
# - /modem/<mac>/pre-eq         → Use /api/pypnm/modem/<mac>/pre-eq
# - /modem/<mac>/channel-info   → Use /api/pypnm/modem/<mac>/channel-stats
# - /modem/<mac>/event-log      → Use /api/pypnm/modem/<mac>/event-log
#
# See backend/REMOVED_ENDPOINTS.md for full migration guide.
# ============================================================
