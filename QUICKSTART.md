...
cd PyPNMGui  # or wherever you cloned it
...
4. **Read Documentation:**
   ...
   - [docs/PYPNM_INTEGRATION.md](docs/PYPNM_INTEGRATION.md) - Architecture details
   - [docs/NETWORK_ARCHITECTURE.md](docs/NETWORK_ARCHITECTURE.md) - Network topology
