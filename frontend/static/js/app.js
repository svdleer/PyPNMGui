        ...
        async _reconcileTopologyPhysicalFiberNode({ initializeSelection = false } = {}) {
            ...
            const rows = data.records.filter(record => {
                ...
                return {
                    ...
                    linked_node_id: expected?.linked_node_id || '',
                    topology_node_id: expected?.topology_node_id || '',
                    topology_group_amplifier: expected?.topology_group_amplifier || '',
                    topology_end_amplifier: expected?.topology_end_amplifier || '',
                    topology_tap: expected?.topology_tap || '',
                    topology_path: expected?.hierarchy_path || '',
